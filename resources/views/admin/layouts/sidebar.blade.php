    ...
    <div class="open" id="dashboards">
        <ul>
         ...
         <li>
           ...
           <i class="fa fa-home fa-2x"></i>  &nbsp;Dashboard </span></a>
        </li>
        ...
        <li class="navigation-divider" style="margin: 0px; padding:20px 0px 0px 30px">About-US</li>
         <li>
            <a  href="" data-toggle="tooltip" data-placement="right" title="Manage Blogs"
               data-nav-target="#dashboards">
                <i class="fa fa-newspaper-o"></i>&nbsp; Manage About-Us</a>
                <ul>
                      <li><a href="{{route('admin.AboutCreate')}}">Create </a></li>
                      <li><a href="{{route('admin.about.index')}}">Manage </a></li>
                </ul>
        </li>  

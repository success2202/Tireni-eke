            ...
            <div class="row app-block">
                ...
                <div class="col-md-9 app-content">
                    ...
                    <div class="card card-body app-content-body">
                        <div class="app-lists">
                            <form action="{{ route('admin.settings.termsConditionsUpdate', encrypt($termsConditions->id)) }}" method="POST">
                            @csrf
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item"> 
                                    <div class="flex-grow-1 min-width-0">
                                        <div class="mb-1 d-flex justify-content-between align-items-center">
                                            <div class="text-truncate app-list-title">Edit Terms Conditions</div>
                                ...
                                <div style="float:right" class="pl-5 pt-3">
                                    ...
                                    <button type="submit" class="btn btn-primary w-20">Update Terms and Conditions</button>
                                </div>
